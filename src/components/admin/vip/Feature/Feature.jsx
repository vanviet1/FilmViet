...
function Feature(props) {
    ...
    const [errors, setError] = useState(inner);
     ...
     const [filteredFeature, setFilteredFeature] = useState(features);
            // Pagination states
    ...
    const [rowsPerPage, setRowsPerPage] = useState(5);
        ...
        const handleClose = () => {
         ...
         const handleSearch = () => { 
                ...
                const filtered = features.filter((cat) =>
        ...
        const handleChangeRowsPerPage = (event) => {
          ...
          const paginatedFeature = filteredFeature.slice(
            page * rowsPerPage,
        ...
        return (
            ...
            <div>
                    <TableFeature page={page} filteredFeature={paginatedFeature} feature={feature} features={features} setFeature={setFeature} setOpen = {setOpen}  />
                </div>
                 ...
                 <ModalFeature open={open} handleClose={handleClose}  feature={feature} setFeature={setFeature} errors={errors} setError={setError}/>
